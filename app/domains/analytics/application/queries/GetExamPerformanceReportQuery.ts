...
export class GetExamPerformanceReportQuery extends BaseQuery<ExamPerformanceParams, ExamPerformanceReport> {
    constructor(private readonly svc: AnalyticsService) {
        super();
    }

    protected async executeBusinessLogic(input: ExamPerformanceParams): Promise<ExamPerformanceReport> {
