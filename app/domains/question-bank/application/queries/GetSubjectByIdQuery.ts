...
export class GetSubjectByIdQuery extends BaseQuery<SubjectIdParams, RetrieveOneSchema<SubjectDetail>> {
  constructor(private readonly serv: SubjectService) { super(); }

  protected async executeBusinessLogic(input: SubjectIdParams): Promise<RetrieveOneSchema<SubjectDetail>> {
