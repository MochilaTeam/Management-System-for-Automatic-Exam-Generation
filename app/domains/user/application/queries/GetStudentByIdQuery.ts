...
export class GetStudentByIdQuery extends BaseQuery<StudentIdParams,RetrieveOneSchema<StudentRead>> {
  constructor(private readonly service: StudentService){
    super();
  }

  protected async executeBusinessLogic(input: StudentIdParams): Promise<RetrieveOneSchema<StudentRead>> {
